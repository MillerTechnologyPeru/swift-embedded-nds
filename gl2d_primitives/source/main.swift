...
func simple(_ frame: Int32) {
	...
	GL2D.boxFilledGradient(x1: 0, y1: 0, x2: 255, y2: 191,
	                       color1: rgb15(red, green, blue),
	                       color2: rgb15(blue, 31 - red, green),
	                       color3: rgb15(green, blue, 31 - red),
	                       color4: rgb15(31 - green, red, blue))
	...
	GL2D.triangleFilledGradient(x1: 20, y1: 100, x2: 200, y2: 30, x3: 60, y3: 40,
	                            color1: rgb15(blue, red, green),
	                            color2: rgb15(green, blue, red),
	                            color3: rgb15(red, green, blue))

	GL.polyFmt(POLY_ALPHA(16) | UInt32(POLY_CULL_NONE.rawValue) | POLY_ID(1))
	GL2D.boxFilledGradient(x1: 10, y1: 50, x2: 230, y2: 150,
	                       color1: rgb15(green, 0, 0), color2: rgb15(0, red, 0),
	                       color3: rgb15(31, 0, blue), color4: rgb15(0, red, 31))
	...
	GL2D.triangleFilledGradient(x1: 70, y1: 10, x2: 20, y2: 130, x3: 230, y3: 180,
	                            color1: rgb15(red, green, blue),
	                            color2: rgb15(blue, red, green),
	                            color3: rgb15(green, blue, red))
...
Console.demoInit()
GL2D.screen2D()   // initialise GL in 2D mode

Console.print("\u{1b}[1;1HEasy GL2D Primitives Example")
Console.print("\u{1b}[3;1HRelminator")
Console.print("\u{1b}[4;1HHttp://Rel.Phatcode.Net")
Console.print("\u{1b}[6;1HPress Arrow keys to Change FX")
...
while System.mainLoop {
	...
	Console.printf("\u{1b}[10;1HDemo# %i/3", Int32(demonum + 1))
	Console.print("\u{1b}[11;1HTitle: ")
	Console.print(demoTitle(demonum))
}
